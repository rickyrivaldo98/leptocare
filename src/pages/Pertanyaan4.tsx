...
const Pertanyaan4: React.FC<props> = ({ setForm, formData }) => {
            ...
            <IonPage className="relative">
                ...
                <div className="bg-white h-2/3 px-4">
                    <div className="pt-5 space-y-5">
                        <div onClick={() => { setActive(1); setNilai(1); setForm({ ...formData, pertanyaan4: 1 }) }} className={`relative rounded-md p-4 flex justify-between border ${active === 1 ? "border-green-700 bg-green-200" : "border-gray-300"} `}>
                        ...
                        <div onClick={() => { setActive(2); setNilai(2); setForm({ ...formData, pertanyaan4: 0 }) }} className={`relative rounded-md p-4 flex justify-between border ${active === 2 ? "border-red-700 bg-red-200" : "border-gray-300"} `}>
                            <label className="mr-3 cursor-pointer">
